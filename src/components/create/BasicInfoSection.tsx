              ...
              >
                {["0-2", "3-5", "6-8", "9-10", "10-99"].map((age) => (
                  <div key={age} className="relative">
                    ...
                    <label
                      htmlFor={`age-${age}`}
                      className="flex items-center justify-center px-4 py-2 bg-[#FFF0F9] rounded-md cursor-pointer hover:bg-[#E535AB] hover:text-white transition-colors text-[#333333] border-2 border-transparent peer-checked:bg-[#E535AB] peer-checked:text-white peer-checked:border-[#E535AB] peer-checked:hover:bg-[#E535AB]"
                    >
                      {age}
                    </label>
                  </div>
