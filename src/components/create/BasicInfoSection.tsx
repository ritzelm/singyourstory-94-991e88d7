              ...
              >
                {["0-2", "3-5", "6-8", "9-10", "10-99"].map((age) => (
                  <div key={age} className="relative">
                    ...
                    <label
                      htmlFor={`age-${age}`}
                      className="flex items-center justify-center px-4 py-2 rounded-md cursor-pointer text-[#333333] border-2 border-transparent bg-[#FFF0F9] peer-checked:bg-[#E535AB] peer-checked:text-white hover:bg-[#E535AB] hover:text-white transition-all"
                    >
                      {age}
                    </label>
                  </div>
